...
HD_PWD='C:/Users/tran0966/Downloads/Lab6-16BitMultiplier.xpr/Lab6-16BitMultiplier/Lab6-16BitMultiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTIPLIER_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MULTIPLIER_16.tcl -notrace
