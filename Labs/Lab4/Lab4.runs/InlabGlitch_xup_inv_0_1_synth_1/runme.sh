...
HD_PWD='C:/Users/tran0966/Lab4/Lab4.runs/InlabGlitch_xup_inv_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InlabGlitch_xup_inv_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InlabGlitch_xup_inv_0_1.tcl
