...
#
# Generated by export_simulation on Mon Nov 04 08:27:35 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './prelabGlitch.sh' script.

./prelabGlitch.sh -reset_run
...
./prelabGlitch.sh -noclean_files

For more information on the script, please type './prelabGlitch.sh -help'.
