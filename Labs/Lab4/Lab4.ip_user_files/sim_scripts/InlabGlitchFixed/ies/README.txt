...
#
# Generated by export_simulation on Fri Nov 08 13:50:16 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './InlabGlitchFixed.sh' script.

./InlabGlitchFixed.sh -reset_run
...
./InlabGlitchFixed.sh -noclean_files

For more information on the script, please type './InlabGlitchFixed.sh -help'.
