...
#
# Generated by export_simulation on Mon Nov 04 09:59:00 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './InlabGlitch.sh' script.

./InlabGlitch.sh -reset_run
...
./InlabGlitch.sh -noclean_files

For more information on the script, please type './InlabGlitch.sh -help'.
