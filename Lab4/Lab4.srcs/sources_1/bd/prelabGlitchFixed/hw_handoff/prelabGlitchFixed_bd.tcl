...
################################################################
# This is a generated script based on design: prelabGlitchFixed
#
...
# source prelabGlitchFixed_script.tcl
...
set design_name prelabGlitchFixed
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports B] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net a_0_1 [get_bd_ports A] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_2/a]
  connect_bd_net -net b_0_1 [get_bd_ports C] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_and2_2/b]
  ...
  connect_bd_net -net xup_and2_2_y [get_bd_pins xup_and2_2/y] [get_bd_pins xup_or2_1/b]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_0/b] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_or2_0_y [get_bd_pins xup_or2_0/y] [get_bd_pins xup_or2_1/a]
  connect_bd_net -net xup_or2_1_y [get_bd_ports F] [get_bd_pins xup_or2_1/y]
